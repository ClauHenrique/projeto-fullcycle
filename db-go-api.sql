...
INSERT INTO `catalog_product`.`categories` (`id`,`name`) VALUES ("6b4c28f4-6831-495a-9444-19c93452faa3","Relogios");
INSERT INTO `catalog_product`.`categories` (`id`,`name`) VALUES ("7c0ca0d4-ff23-4bd7-b131-c563067c4b43","Eletronicos");
...
INSERT INTO `catalog_product`.`products` (`id`,`name`,`description`,`price`,`category_id`,`image_url`)
